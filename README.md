...
tcpbbr (https://cloudblog.withgoogle.com/products/gcp/tcp-bbr-congestion-control-comes-to-gcp-your-internet-just-got-<br><br>faster/amp/) 등을 적용해주는 스트립트(.sh) 입니다. <br><br>
# 주의 사항
재배포를 금지합니다. <br><br>
